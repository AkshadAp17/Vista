...
export default function BusinessCard({ variant = 'full', className = '', onClose }: BusinessCardProps) {
  ...
  if (onClose) {
    return (
      ...
      >
        <Card className="bg-gradient-to-br from-orange-50 via-white to-red-50 border-2 border-orange-300 shadow-2xl hover:shadow-3xl transition-all duration-300 backdrop-blur-sm mx-auto max-w-md w-full relative">
          {/* Close Button */}
          <Button
            variant="ghost"
            size="sm"
