        ...
        <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-hema-orange to-orange-600 relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
            <div className="text-center space-y-6 max-w-md">
              ...
              <p className="text-xl text-white/90">Almost there! Just verify your email to get started</p>
              <div className="space-y-4 text-white/80">
                ...
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span>Enter the 6-digit code to activate your account</span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-white rounded-full"></div>
                  <span>Start buying and selling immediately</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-hema-orange to-orange-600 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-white p-12">
          <div className="text-center space-y-6 max-w-md">
            ...
            <h1 className="text-4xl font-bold">Hema Motor</h1>
            <p className="text-xl text-white/90">Your trusted two-wheeler marketplace</p>
            <div className="space-y-4 text-white/80">
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span>Buy & Sell motorcycles, scooters, and electric vehicles</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span>Real-time chat with sellers and buyers</span>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-2 h-2 bg-white rounded-full"></div>
                <span>Secure transactions and verified listings</span>
              </div>
            </div>
          </div>
        </div>
